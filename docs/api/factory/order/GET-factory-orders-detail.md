...
- curl 명령 예시
  ...
  ```
  curl -i -X GET 'http://localhost:8080/api/v1/factory/orders/ORD-20240101-001' \
...
- 인증된 사용자가 속한 공장에 배정된 발주만 조회할 수 있다 (타 공장 발주 조회 시 403)
...
- [ ] 타 공장의 발주를 조회하면 403 Forbidden 상태코드를 반환한다
