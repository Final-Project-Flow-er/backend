...
public class FranchiseInventoryController {
    ...
    public ResponseEntity<ApiResponse<Void>> increaseInventory(
        ...
        return ResponseEntity
                .ok(ApiResponse.success(franchiseInventoryFacade.increaseInventory(inventoryBatchRequest)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> decreaseInventory(
            @Valid @RequestBody InventoryBatchRequest inventoryBatchRequest) {
        return ResponseEntity
                .ok(ApiResponse.success(franchiseInventoryFacade.decreaseInventory(inventoryBatchRequest)));
    }
    ...
    @Operation(summary = "특정 가맹점의 재고 중분류", description = "특정 가맹점의 제조일자별 수량을 확인합니다.")
    ...
    public ResponseEntity<ApiResponse<List<FranchiseInventoryBatchResponse>>> getFranchiseBatches(
        ...
        return ResponseEntity
                .ok(ApiResponse.success(franchiseInventoryFacade.getFranchiseBatches(franchiseId, productId)));
    }

    @Operation(summary = "특정 가맹점의 재고 소분류", description = "특정 가맹점의 상세 제품 정보를 확인합니다.")
    ...
    public ResponseEntity<ApiResponse<Void>> disposalInventory(@Valid @RequestBody DisposalRequest request) {
        return ResponseEntity.ok(ApiResponse.success(franchiseInventoryFacade.disposalInventory(request)));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> setSafetyStock(
        ...
        franchiseInventoryFacade.setSafetyStock(request);
