...
public class HQInventoryLogController {
    ...
    public ResponseEntity<ApiResponse<Page<?>>> findReturnInboundLogs(
    ...
    public ResponseEntity<ApiResponse<Page<?>>> findReturnOutboundLogs(
    ...
    @GetMapping("/disposal")
    public ResponseEntity<ApiResponse<Page<?>>> findDisposalLogs(
            @RequestBody HQLogRequest hqLogRequest,
            Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(null));
    }
    ...
    public ResponseEntity<ApiResponse<Page<?>>> findFranchiseInboundOutboundLogs(
            @PathVariable Long franchiseId,
    ...
    public ResponseEntity<ApiResponse<Page<?>>> findFranchiseSalesRefundLogs(
            @PathVariable Long franchiseId,
            @RequestBody HQFranchiseLogRequest hqFranchiseLogRequest,
            Pageable pageable) {
        return ResponseEntity.ok(ApiResponse.success(null));
