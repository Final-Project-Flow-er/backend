...
class HQOrderServiceTests {
    ...
    void updateOrderItems_GivenValidRequest_ShouldReturnUpdatedItems() {
        ...
        given(orderItemRepository.findAllByHeadOfficeOrder_HeadOfficeOrderIdAndHeadOfficeOrder_OrderCode(userId, orderCode))
        ...
        verify(orderItemRepository, times(1)).findAllByHeadOfficeOrder_HeadOfficeOrderIdAndHeadOfficeOrder_OrderCode(userId, orderCode);
        assertEquals(1, result.size());
