...
class ProductServiceTests {
    ...
    void syncComponents() {
        ...
        // then
        // 삭제 검증 (1 삭제)
        ArgumentCaptor<List<ProductComponent>> deleteCaptor =
        ...
        // 추가 검증 (4 추가)
        ArgumentCaptor<List<ProductComponent>> addCaptor =
                ArgumentCaptor.forClass(List.class);
