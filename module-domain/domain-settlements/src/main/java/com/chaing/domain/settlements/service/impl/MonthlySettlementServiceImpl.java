...
public class MonthlySettlementServiceImpl implements MonthlySettlementService {
    ...
    @Override
    public List<MonthlySettlement> getAllByMonth(YearMonth month) {
    ...
    public Map<String, Long> getStatusCounts(YearMonth month) {
        return Map.of(
                ...
                "CONFIRM_REQUESTED", repository.countBySettlementMonthAndStatus(month, SettlementStatus.CONFIRM_REQUESTED),
